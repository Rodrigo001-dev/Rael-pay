defmodule RaelPay.Accounts.Withdraw do
  alias Ecto.Multi
  ...
  # se eu receber um ok e um valor quer dizer que eu posso subtrair esses valores
  # a função Decimal.sub() vai subtrair dois decimais
